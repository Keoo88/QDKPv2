...
> ⚠️ **`Options.ini` is NOT compatible with the original QDKP2 addon.**

<p align="center">
  <img src="assets/main-panel.png" alt="Quick DKP V2 panel" width="360">
</p>
...
<p align="center">
  <img src="assets/bid-manager.png" alt="Bid Manager" width="760">
</p>
...
<p align="center">
  <img src="assets/roster.png" alt="Guild roster" width="620"><br>
  <img src="assets/raid-log.png" alt="Raid log" width="760">
</p>
...
> ⚠️ Upgrading from another version of QDKPv2 will reset the database — all
> un-uploaded changes, external characters, logs, etc. will be purged.
...
- WotLK 3.3.5a port: molodoy3561@gmail.com
- Community build (bidding / backup / loot improvements): **Fun Pay**
...
> ⚠️ **`Options.ini` НЕ совместим с оригинальным аддоном QDKP2.**

<p align="center">
  <img src="assets/main-panel.png" alt="Панель Quick DKP V2" width="360"><br>
  <img src="assets/bid-manager.png" alt="Bid Manager" width="760">
</p>
...
> ⚠️ При переходе с другой версии QDKPv2 база данных будет сброшена — все
> незагруженные изменения, внешние персонажи, логи и т.д. будут удалены.
...
- Порт под WotLK 3.3.5a: molodoy3561@gmail.com
- Сборка сообщества (доработки ставок / бэкапов / лута): **Fun Pay**
